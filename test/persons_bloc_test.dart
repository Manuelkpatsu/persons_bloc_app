...
import 'package:persons_bloc_app/bloc/bloc_actions.dart';
import 'package:persons_bloc_app/bloc/person.dart';
import 'package:persons_bloc_app/bloc/persons_bloc.dart';
...
void main() {
  group(
    ...
    () {
      ...
      blocTest<PersonsBloc, FetchResult?>(
        'Retrieving persons from first iterable',
        build: () => bloc,
        act: (bloc) {
          bloc.add(
      ...
      blocTest<PersonsBloc, FetchResult?>(
        'Retrieving persons from second iterable',
        build: () => bloc,
        act: (bloc) {
          bloc.add(
            const LoadPersonsAction(
